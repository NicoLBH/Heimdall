...
const SUBJECT_DEFAULT_LABEL_DEFINITIONS = [
  { key: "bloquant", label: "bloquant", description: "Empêche l'avancement ou la décision.", color: "rgba(182, 2, 5, 0.18)", textColor: "rgb(254, 155, 156)", borderColor: "rgb(254, 155, 156)" },
  { key: "critique", label: "critique", description: "Point majeur à traiter en priorité.", color: "rgba(217, 63, 11, 0.18)", textColor: "rgb(247, 140, 104)", borderColor: "rgb(247, 140, 104)" },
  { key: "sensible", label: "sensible", description: "Sujet délicat nécessitant de la vigilance.", color: "rgba(83, 25, 231, 0.18)", textColor: "rgb(219, 207, 250)", borderColor: "rgb(219, 207, 250)" },
  { key: "non conforme", label: "non conforme", description: "Écart constaté par rapport aux exigences.", color: "rgba(182, 2, 5, 0.18)", textColor: "rgb(254, 155, 156)", borderColor: "rgb(254, 155, 156)" },
  { key: "incident", label: "incident", description: "Événement ou anomalie signalé(e).", color: "rgba(217, 63, 11, 0.18)", textColor: "rgb(247, 140, 104)", borderColor: "rgb(247, 140, 104)" },
  { key: "réserve", label: "réserve", description: "Point à lever ou à suivre avant clôture.", color: "rgba(251, 202, 4, 0.18)", textColor: "rgb(251, 202, 4)", borderColor: "rgb(251, 202, 4)" },
  { key: "question", label: "question", description: "Clarification attendue sur ce point.", color: "rgba(212, 197, 249, 0.18)", textColor: "rgb(210, 195, 249)", borderColor: "rgb(210, 195, 249)" },
  { key: "à arbitrer", label: "à arbitrer", description: "Décision de pilotage ou d'arbitrage requise.", color: "rgba(254, 242, 192, 0.18)", textColor: "rgba(254, 242, 192, 0.18)", borderColor: "rgba(254, 242, 192, 0.18)" },
  { key: "validation requise", label: "validation requise", description: "Validation formelle attendue.", color: "rgba(191, 218, 220, 0.18)", textColor: "rgb(192, 219, 221)", borderColor: "rgb(192, 219, 221)" },
  { key: "à préciser", label: "à préciser", description: "Informations complémentaires nécessaires.", color: "rgba(29, 118, 219, 0.18)", textColor: "rgb(107, 167, 236)", borderColor: "rgb(107, 167, 236)" },
  { key: "information", label: "information", description: "Point purement informatif.", color: "rgba(0, 107, 117, 0.18)", textColor: "rgb(0, 232, 253)", borderColor: "rgb(0, 232, 253)" },
  { key: "refusé", label: "refusé", description: "Demande ou proposition rejetée.", color: "rgba(182, 2, 5, 0.18)", textColor: "rgb(254, 155, 156)", borderColor: "rgb(254, 155, 156)" },
  { key: "variante", label: "variante", description: "Solution alternative proposée.", color: "rgba(29, 118, 219, 0.18)", textColor: "rgb(107, 167, 236)", borderColor: "rgb(107, 167, 236)" },
  { key: "modification", label: "modification", description: "Évolution demandée sur l'existant.", color: "rgba(0, 82, 204, 0.18)", textColor: "rgb(108, 167, 255)", borderColor: "rgb(108, 167, 255)" },
  { key: "optimisation", label: "optimisation", description: "Amélioration possible identifiée.", color: "rgba(14, 138, 22, 0.18)", textColor: "rgb(23, 230, 37)", borderColor: "rgb(23, 230, 37)" },
  { key: "correction", label: "correction", description: "Action corrective à mettre en œuvre.", color: "rgba(194, 224, 198, 0.18)", textColor: "rgb(194, 224, 198)", borderColor: "rgb(194, 224, 198)" },
  { key: "action moa", label: "action MOA", description: "Action attendue de la maîtrise d'ouvrage.", color: "rgba(191, 212, 242, 0.18)", textColor: "rgb(192, 213, 242)", borderColor: "rgb(192, 213, 242)" },
  { key: "action moe", label: "action MOE", description: "Action attendue de la maîtrise d'œuvre.", color: "rgba(191, 212, 242, 0.18)", textColor: "rgb(192, 213, 242)", borderColor: "rgb(192, 213, 242)" },
  { key: "action entreprise", label: "action Entreprise", description: "Action attendue de l'entreprise travaux.", color: "rgba(191, 212, 242, 0.18)", textColor: "rgb(192, 213, 242)", borderColor: "rgb(192, 213, 242)" },
  { key: "action bet", label: "action BET", description: "Action attendue du bureau d'études.", color: "rgba(191, 212, 242, 0.18)", textColor: "rgb(192, 213, 242)", borderColor: "rgb(192, 213, 242)" },
  { key: "coordination", label: "coordination", description: "Coordination nécessaire entre acteurs.", color: "rgba(83, 25, 231, 0.18)", textColor: "rgb(219, 207, 250)", borderColor: "rgb(219, 207, 250)" },
  { key: "doublon", label: "doublon", description: "Sujet déjà couvert ailleurs.", color: "rgba(0, 0, 0, 0)", textColor: "rgb(208, 212, 216)", borderColor: "rgb(208, 212, 216)" },
  { key: "hors périmètre", label: "hors périmètre", description: "En dehors du périmètre de traitement.", color: "rgba(0, 0, 0, 0)", textColor: "rgb(208, 212, 216)", borderColor: "rgb(208, 212, 216)" },
  { key: "sans suite", label: "sans suite", description: "Point clos sans action complémentaire.", color: "rgba(0, 0, 0, 0)", textColor: "rgb(208, 212, 216)", borderColor: "rgb(208, 212, 216)" }
];
